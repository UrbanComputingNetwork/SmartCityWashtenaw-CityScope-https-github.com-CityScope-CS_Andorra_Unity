...
public static class TriangulatorDelaunay
{
    ...
    public static GameObject CreateInfluencePolygon(Vector2[] XZofVertices)
    {
    ...
    public static GameObject CreateInfluencePolygon(Vector3[] Vertices, GameObject gameObject = null)
    {
        Vector2[] XZofVertices = new Vector2[Vertices.Length];
        for (int ii1 = 0; ii1 < XZofVertices.Length; ii1++)
        {
            XZofVertices[ii1] = new Vector2(Vertices[ii1].x, Vertices[ii1].z);
        }
        GameObject OurNewMesh = gameObject == null ? new GameObject("OurNewMesh1") : gameObject;
        Mesh mesh = new Mesh();
        mesh.vertices = Vertices;
        mesh.uv = XZofVertices;
        mesh.triangles = TriangulatePolygon(XZofVertices);
